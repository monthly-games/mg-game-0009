...
void main() {
  ...
  group('Screenshot Capture', () {
    testWidgets('Capture all store screens', (WidgetTester tester) async {
      ...
      await binding.takeScreenshot('MG-0009/01_main_menu');
      ...
      if (tester.any(startButton)) {
        ...
        await binding.convertFlutterSurfaceToImage();
        await binding.takeScreenshot('MG-0009/02_game_play_initial');
        ...
        await binding.convertFlutterSurfaceToImage();
        await binding.takeScreenshot('MG-0009/03_game_play_progressed');
      ...
      if (tester.any(roadmapButton)) {
        ...
        await binding.convertFlutterSurfaceToImage();
        await binding.takeScreenshot('MG-0009/04_level_roadmap');
      ...
      if (tester.any(dailyButton)) {
        ...
        await binding.convertFlutterSurfaceToImage();
        await binding.takeScreenshot('MG-0009/05_daily_quests');
      ...
      if (tester.any(tournamentButton)) {
        ...
        await binding.convertFlutterSurfaceToImage();
        await binding.takeScreenshot('MG-0009/06_tournament');
      ...
      if (tester.any(eventButton)) {
        ...
        await binding.convertFlutterSurfaceToImage();
        await binding.takeScreenshot('MG-0009/07_seasonal_event');
