...
class _TutorialOverlayState extends State<TutorialOverlay>
  ...
  final List<TutorialStep> _steps = const [
    TutorialStep(
      ...
      description: 'Swipe or use arrow keys to change direction',
      icon: Icons.swipe,
      iconPosition: Alignment.center,
    ),
    TutorialStep(
      title: 'Eat the Food',
      description: 'Collect red food to grow longer and score points',
      icon: Icons.restaurant,
      iconPosition: Alignment.centerRight,
    ),
    TutorialStep(
      title: 'Don\'t Crash!',
      description: 'Avoid hitting walls and yourself',
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      color: MGColors.backgroundDark.withValues(alpha: 0.85),
      child: SafeArea(
  ...
  Widget _buildSwipeArrow(IconData icon) {
