...
const kCardWarriorMeta = SpineAssetMeta(
  ...
  skeletonPath: 'assets/spine/characters/card_warrior/card_warrior.skel',
...
const kCardMageMeta = SpineAssetMeta(
  ...
  skeletonPath: 'assets/spine/characters/card_mage/card_mage.skel',
  animations: ['idle', 'walk', 'attack', 'hit'],
  defaultAnimation: 'idle',
  defaultMix: 0.2,
);
...
const kCardArcherMeta = SpineAssetMeta(
  ...
  skeletonPath: 'assets/spine/characters/card_archer/card_archer.skel',
  animations: ['idle', 'walk', 'attack', 'hit'],
  defaultAnimation: 'idle',
  defaultMix: 0.2,
);
