...
이 프로젝트는 **카드 퍼즐 RPG**의 Flutter 구현체입니다.
...
| 문서 | 설명 |
|------|------|
| [docs/design/gdd_game_0009.json](docs/design/gdd_game_0009.json) | 게임 디자인 문서 |
...
**HUD 파일**: [game/lib/ui/hud/mg_card_puzzle_hud.dart](game/lib/ui/hud/mg_card_puzzle_hud.dart)
